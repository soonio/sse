...
var ProviderSet = wire.NewSet(redis.NewClient, hub.NewHub, limiter.NewLimiter, provideBufferPool, pool.NewMessagePool, notify.NewService, wire.Bind(new(push.Notifier), new(*notify.Service)), push.NewService, monitor.NewMonitor, wire.Bind(new(monitor.Counter), new(*hub.Hub)), provideRouter,
